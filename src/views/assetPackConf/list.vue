  ...
  <div class="app-container">
    <el-form :inline="true" :model="form">
      ...
      <el-form-item label="进件渠道">
          ...
          <el-select v-model="form.prodCode" filterable>
            <el-option key="" label="全部" value=""></el-option>
            <el-option v-for="item in $store.state.globalData.product" :key="item.prodCode" :label="item.prodName" :value="item.prodCode"></el-option>
          </el-select>
      </el-form-item>
    ...
    <div class="table-container">
      ...
      <el-table ref="multipleTable" :data="tableData" border :stripe="stripe" style="width: 100%">
        ...
        <el-table-column prop="caseLabel" label="资产标签">
        </el-table-column>
        ...
        <el-table-column label="输出比例">
          <template slot-scope="scope" v-if="scope.row.ouputRate && scope.row.ouputRate != ''">
              {{ scope.row.ouputRate }}%
          </template>
        </el-table-column>
