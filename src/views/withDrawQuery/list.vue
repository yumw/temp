  ...
  <div class="app-container">
    ...
    <div class="table-container">
      <el-table ref="multipleTable" :data="tableData" border :stripe="stripe" style="width: 100%">
        ...
        <el-table-column prop="loanNo" label="提现流水号" min-width="150"></el-table-column>
        <el-table-column prop="partnerCode" label="资方编号" min-width="120"></el-table-column>
        <el-table-column prop="partnerName" label="资方名称" min-width="120"></el-table-column>
        <el-table-column prop="loanAmount" label="提现金额" min-width="120"></el-table-column>
        <el-table-column prop="approvalStatus" label="用信状态" min-width="120">
          <template
            slot-scope="scope"
          >{{ scope.row.approvalStatus | approvalStatus }}</template>
        </el-table-column>
        <el-table-column prop="distApplyTime" label="用信分发时间" min-width="160"></el-table-column>
        <el-table-column prop="loanStatus" label="放款状态" min-width="80">
          <template
            slot-scope="scope"
          >{{ scope.row.loanStatus | loanStatus }}</template>
        </el-table-column>
        <el-table-column prop="distAdvaneTime" label="放款分发时间" min-width="160"></el-table-column>
