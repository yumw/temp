<template>
  <div class="app-container">  
    <div class="table-container">
      <el-table ref="multipleTable" :data="partner" border :stripe="stripe" style="width: 100%">
        ...
        <el-table-column label="是否我司催收" fixed="right" width="160">
          <template slot-scope="scope">
            <el-radio-group :value="scope.row.isUrgeRepay">
...
<script>
import { findPartner, updatePartnerIsUrgeRepay } from '@/api/partner'
...
export default {
  ...
  methods: {
    ...
    edit(params){
      updatePartnerIsUrgeRepay(params).then(res => {
        if (res) {
