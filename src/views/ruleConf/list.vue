  ...
  <div class="app-container">
    ...
    <div class="table-container">
      ...
      <el-table ref="multipleTable" :data="tableData" border :stripe="stripe" style="width: 100%">
        ...
        <el-table-column prop="partnerCode" label="被分发资方编号">
        </el-table-column>
        <el-table-column prop="partnerName" label="被分发资方名称">
        </el-table-column>
        ...
        <el-table-column prop="dayLimit" label="每日分发上限/笔">
        </el-table-column>
        ...
        <el-table-column prop="paymentType" label="操作" fixed="right" width="160">
          <template slot-scope="scope">
            <el-button @click="edit(scope.row)" size="small" type="warning" v-if="hasPerm('updateRule')">编辑</el-button>
