<template>
  <div class="app-container">
    <div class="table-container">
      ...
      <el-table ref="multipleTable" :data="channel" border>
        ...
        <el-table-column prop="paymentType" label="操作" fixed="right" width="160">
          <template slot-scope="scope">
            <el-button @click="edit(scope.row)" size="small" type="warning" v-if="hasPerm('addChannel')">编辑</el-button>
            <el-button @click="del(scope.row)" size="small" type="danger" v-if="hasPerm('deleteChannel')">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
    </div>
